...
/**
*  Controller - Classe de controle pour r�aliser les actions sur la base de donn�e
*
* @version 1.1
*
...
//		server = "localhost";
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Annee dans la base de donn�e
	 * @param getRequete
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Competence dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Domaine dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Item dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Etudiant dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Evaluation dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type EvaluationEtudiant dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	//Sera px etre supprim�
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Interrvenant dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Semestre dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Ue dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Diplome dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Ec dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Cette fonction va r�cup�rer les objets de type Promotion dans la base de donn�e
	 * @param getRequete
	 * @return liste d'objet du type de la donn�e
	 */
	...
	//Get Sql functions
	/**
	 * Cette fonction permet de compter les �l�ments
	 * @param getRequete
	 * @param champAs
	 * @return liste d'objet du type de la donn�e
	 */
	...
	/**
	 * Fonction permettatnt de faire toute requ�te de modification (insert, update, delete ....)
	 * @param getRequete
	 */
	 ...
	 *  Z� pa Consern� 
	 *    
	 *  java et reflexcivit� - Instanciation dynamique
	 * 
	 */
