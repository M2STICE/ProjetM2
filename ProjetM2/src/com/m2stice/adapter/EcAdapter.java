...
public class EcAdapter {
	...
	public LinkedList<Ec> getSelect(String getRequete) {
		...
		if (resultat != null) {
			try {
				while(resultat.next()){						                                                                                                                                                                                                                                  
					list.add(new Ec( resultat.getInt("code_ec"),resultat.getString("nom_ec"), resultat.getFloat("coefficient_ec"), resultat.getInt("nombre_ects"), resultat.getFloat("volume_heure_cours"), resultat.getFloat("volume_heure_TP"), resultat.getFloat("volume_heure_TD"), resultat.getFloat("volume_heure_BE"), resultat.getFloat("volume_heure_TPERSO"), resultat.getString("resume_ec"), resultat.getInt("code_ue"), resultat.getInt("responsable_ec"), resultat.getInt("code_semestre")));
				}
